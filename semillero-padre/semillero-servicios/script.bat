...
del /F /S /Q *.deployed
echo Copiando .ear
xcopy D:\Archivos de Daniel\Semillero Java y Angular\semillero-hbt\semillero-padre\semillero-ear\target\semillero-ear-1.0-SNAPSHOT.ear "C:\wildfly-15.0.1.Final\standalone\deployments"  
echo Ejecutando .bat
