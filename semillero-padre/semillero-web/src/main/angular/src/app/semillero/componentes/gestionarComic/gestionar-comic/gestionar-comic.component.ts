...
export class GestionarComicComponent implements OnInit {
  ...
  public consultarUnComic() {
    this.gestionComicsService.consultarUnComic(this.comicDTO).subscribe(data=> {
      if (data.exitoso) {
        this.listaComics = data;
      } else {
        console.log(data.mensajeEjecucion);
  ...
  /**Funcion encargada de re-direccionar la pagina para visualizar el componente gestionar-Compra
   * 
   * @param comic 
   */
